    ...
    <footer className="bg-slate-950 py-16 text-gray-400 text-sm border-t border-white/5">
      <div className="container mx-auto px-4 md:px-6">
        <div className="grid grid-cols-1 md:grid-cols-[1.5fr_1fr_1fr] gap-12 mb-12">
          ...
          <div>
            <Link href="/" onClick={scrollToTop} className="flex items-center gap-2 mb-6">
          ...
          <div>
            ...
            <ul className="space-y-3">
              {services.map((service) => (
                <li key={service.slug}>
                  <Link href={`/services/${service.slug}`} onClick={scrollToTop} className="hover:text-primary transition-colors">
                    {service.title}
                  </Link>
                </li>
              ))}
          ...
          <div>
            ...
            <ul className="space-y-3">
              <li><Link href="/services" onClick={scrollToTop} className="hover:text-primary transition-colors">All Services</Link></li>
              <li><Link href="/global-reach" onClick={scrollToTop} className="hover:text-primary transition-colors">Global Reach</Link></li>
              <li><Link href="/expertise" onClick={scrollToTop} className="hover:text-primary transition-colors">Expertise</Link></li>
              <li><Link href="/contact" onClick={scrollToTop} className="hover:text-primary transition-colors">Contact</Link></li>
            </ul>
          </div>
        </div>
